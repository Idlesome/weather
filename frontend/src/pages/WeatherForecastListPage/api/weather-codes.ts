...
export type WeatherCode = keyof typeof weatherCodesDay;

export const getWeatherCodeDescription = (code: WeatherCode) => {
  const weatherCodeDescription = weatherCodesDay[code];
  if (weatherCodeDescription) {
